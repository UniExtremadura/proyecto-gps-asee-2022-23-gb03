...
public class TestCU10_ConsultarClasificacion {
    ...
    @Test
    public void testCU10_ConsultarClasificacion() throws InterruptedException {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edit_password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("admin1234"), closeSoftKeyboard());
