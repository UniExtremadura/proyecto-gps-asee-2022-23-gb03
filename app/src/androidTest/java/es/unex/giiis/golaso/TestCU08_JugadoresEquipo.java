...
public class TestCU08_JugadoresEquipo {
    ...
    @Test
    public void testCU08_JugadoresEquipo() throws InterruptedException {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edit_password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("rudnejdjw"), closeSoftKeyboard());
