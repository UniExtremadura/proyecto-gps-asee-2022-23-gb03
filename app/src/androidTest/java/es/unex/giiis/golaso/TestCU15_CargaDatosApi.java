...
public class TestCU15_CargaDatosApi {
    ...
    @Test
    public void testCU15_CargaDatosApi() throws InterruptedException {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edit_password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("user12345"), closeSoftKeyboard());
        ...
        ViewInteraction bottomNavigationItemView = onView(
                allOf(withId(R.id.nav_home), withContentDescription("Partidos"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction bottomNavigationItemView2 = onView(
                allOf(withId(R.id.nav_fav), withContentDescription("Favoritos"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.nav_view),
                                        0),
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withId(com.bumptech.glide.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("h"), closeSoftKeyboard());
        ...
        ViewInteraction searchAutoComplete2 = onView(
                allOf(withId(com.bumptech.glide.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete2.perform(replaceText("b"), closeSoftKeyboard());
