...
public class TestCU11_JugadorDetail {
    ...
    @Test
    public void testCU11_JugadorDetail() throws InterruptedException {
        ...
        ViewInteraction searchAutoComplete = onView(
                allOf(withId(com.bumptech.glide.R.id.search_src_text),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        searchAutoComplete.perform(replaceText("rober"), closeSoftKeyboard());
