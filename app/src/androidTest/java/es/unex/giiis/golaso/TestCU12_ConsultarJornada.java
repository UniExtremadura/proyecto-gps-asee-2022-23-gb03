...
public class TestCU12_ConsultarJornada {
    ...
    @Test
    public void testCU12_ConsultarJornada() throws InterruptedException {
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edit_password),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("1234689"), closeSoftKeyboard());
        Thread.sleep(1000);
